...
/*        public Pais[] LeerNPaises(int nPaises)
        ...
        public Dictionary<string,Pais> LeerTodosPaises()
        {
            var paisesLista = new Dictionary<string,Pais>();
            ...
            using (StreamReader sr = new StreamReader(_csvRutaArchivo))
            {
                ...
                {
                    var paisExtraido = GuardarPaisCsv(csvLine);
                    paisesLista.Add(paisExtraido.Code, paisExtraido);
                }
